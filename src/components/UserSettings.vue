      ...
      <div class="row">
        <div class="col-md-3 border-right">
          <div class="d-flex flex-column align-items-center text-center p-3 py-5"><img class="rounded-circle mt-5" width="150px" src="https://st3.depositphotos.com/15648834/17930/v/600/depositphotos_179308454-stock-illustration-unknown-person-silhouette-glasses-profile.jpg"><label class="font-weight-bold">Firstname</label><span class="labels">{{store.user.firstName}}</span><label class="font-weight-bold">Lastname</label><span class="labels">{{store.user.lastName}}</span>
            ...
            <label class="font-weight-bold">Username</label><span class="labels">{{store.user.userName}}</span>
            <label class="font-weight-bold">password</label><span class="labels">{{store.user.password}}</span>
          </div>
        </div>
        <div class="col-md-5 border-right">
          <div class="p-3 py-5">
            ...
            <div class="row mt-3">
            <div class="col-md-6"><label class="labels">Username</label><input type="text" class="form-control" placeholder="Username"  v-model="userName"></div>
            </div>
            <div class="row mt-3">
            <div class="col-md-6"><label class="labels">Password</label><input type="text" class="form-control"  placeholder="Password" v-model="password" ></div>
            </div>
  ...
  methods: {
    async editUserSettings() {
      ...
      if (this.password.length<1) {
        this.password = store.user.password
      }
